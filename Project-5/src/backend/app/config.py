...
class Settings(BaseSettings):
    APP_NAME: str = "OCI MediaStream-AI Transcriber"
    ...
    OCI_SPEECH_ENDPOINT: str = "https://speech.aiservice.us-ashburn-1.oci.oraclecloud.com"
    OCI_BUCKET_NAME: str = "mediastream-bucket"
